...
<div id="page">
    ...
    <!--KODLAR  BU BÖLÜME YAZILACAK....-->
        <div id="content"><!-- InstanceBeginEditable name="EditRegion1" -->
        	...
        	<h2>Kişisil</h2>
		        <table border="1px">
            <tr><td>KİŞİ İD</td><td>KİŞİ ADI</td><td>KİŞİ  FİYATİ </td><td>SİL</td></tr>
            <?php
			if(isset($_GET["kisid"])){
			$gelen=$_GET["kisid"];
			mysql_query("delete from kisiler where kisid='$gelen'");
		...
		echo "<td>";
		echo "<a href='kisisil.php?kisid=".$satir["kisid"]."'>SİL</a>";
		echo "</td>";
		echo "</tr>";
		}
		?>
