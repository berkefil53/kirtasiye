...
<div id="page">
    ...
    <!--KODLAR  BU BÖLÜME YAZILACAK....-->
        <div id="content"><!-- InstanceBeginEditable name="EditRegion1" -->
        	...
        	<h2>ÜRÜNLER SAYFASI</h2>
            <table border="1px">
            <tr><td>URUN İD</td><td>URUN ADI</td><td>URUN FİYATİ </td><td>URUN GÜNCELLE</td></tr>
			<?php
			...
			echo "<td><a href='urunguncelle.php?uid=".$satir["uid"]."'>GÜNCELLE</a></td>";
			echo "</tr>";		
			}
