...
<div id="page">
    ...
    <!--KODLAR  BU BÖLÜME YAZILACAK....-->
        <div id="content"><!-- InstanceBeginEditable name="EditRegion1" -->
          ...
          Urun:<input name="uadi" type="text" />
            Fiyatı:<input name="ufiyat" type="text" />
          <input name="kaydet" type="submit" value="ekle"  />
          </form>

        <table border="1px">
            <tr><td>URUN İD</td><td>URUN ADI</td><td>URUN FİYATİ </td></tr>
            <?php
			if(isset($_POST["kaydet"])){
			$uadi=$_POST["uadi"];
			$ufiyat=$_POST["ufiyat"];
				mysql_query("INSERT INTO urunler (uadi,ufiyat) VALUES ('$uadi','$ufiyat')");
		}		
